...
1. [Spec](website/spec.md) — Page requirements, tech stack, acceptance criteria
2. [Design Brief](website/design-brief.md) — Visual direction
3. [Backlog](website/backlog.md) — What to build, in what order

## Everything else

- [Ideas & Todos](ideas/index.md) — Every founder idea, speculative direction, and deferred item
- [Reference](reference/) — Raw source material (founder recordings, Q&A, technical explorations)
